...
parser.add_argument('--K', type=int, default=8, help='Propagation step')
parser.add_argument('--sample', type=int, default=6, help='Sampling times of dropnode')
...
'''
α为5，置信度为0.61   使用了数据增强，置信度感知传播以及kl散度，效果为86.07
'''
